...
if (WIN32 AND NOT UNIX)
	...
	FILE(GLOB myProject_GUIDE "${PROJECT_BINARY_DIR}/bin/Release/font/*.*") 
	FOREACH(F ${myProject_ICONS})
		INSTALL(FILES "${F}" DESTINATION ./font)
	ENDFOREACH(F)	
	...
	FILE(GLOB myProject_PRINTSUPPORT "${PROJECT_BINARY_DIR}/bin/Release/printsupport/*.*") 
	FOREACH(F ${myProject_SETTINGS})
		INSTALL(FILES "${F}" DESTINATION ./printsupport)
	ENDFOREACH(F)
